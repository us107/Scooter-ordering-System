        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your scooter</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order and Pay</a></li>

                </ul>
            </div>
        </div>
        <?php $ress= mysqli_query($db,"select * from manufacturers where rs_id='$_GET[res_id]'");
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php  
									$stmt = $db->prepare("select * from scooters where rs_id='$_GET[d_id]'");
									$stmt->execute();
